...
namespace GospelWorld.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> userManager, RoleManager<IdentityRole, string> roleManager)
        {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    if (userManager.IsInRole(user.Id, /*ConfigurationManager.AppSettings["Adminkey"]*/ "Admin"))
                    {
                        return Redirect(GetRedirectUrl(returnUrl));
                    }
                    else if (userManager.IsInRole(user.Id, /*ConfigurationManager.AppSettings["DeptLeaderRole"]*/"DepartmentLeader"))
                    {
        ...
        {
            Request.GetOwinContext().Authentication.SignOut(DefaultAuthenticationTypes.ApplicationCookie/*"ApplicationCookie"*/);
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            ...
            else if (user.UserName == /*ConfigurationManager.AppSettings["deptusername"]*/ "departmentleader@praiseassembly.com" && model.Password == /*ConfigurationManager.AppSetting*//*s["deptpass"]*/ "deptleader")
            {
